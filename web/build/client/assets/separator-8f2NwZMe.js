...
var o = (e) => (typeof e == `boolean` ? `${e}` : e === 0 ? `0` : e),
  s = a,
  c = (e, t) => (n) => {
...
function m(e) {
  let t = g(e),
    n = u.forwardRef((e, n) => {
      ...
      return (0, p.jsx)(t, { ...i, ref: n, children: r });
    });
  ...
  let t = u.forwardRef((e, t) => {
    ...
    if (u.isValidElement(n)) {
      let e = y(n),
        i = v(r, n.props);
      return (
        n.type !== u.Fragment && (i.ref = t ? f(t, e) : e),
        u.cloneElement(n, i)
      );
    }
...
var S = `Separator`,
  C = `horizontal`,
  ne = [`horizontal`, `vertical`],
  re = u.forwardRef((e, t) => {
    let { decorative: n, orientation: r = C, ...i } = e,
      a = w(r) ? r : C,
      o = n
        ? { role: `none` }
        : {
    ...
    return (0, p.jsx)(b.div, { "data-orientation": a, ...o, ...i, ref: t });
  });
re.displayName = S;
function w(e) {
...
var ie = re,
  ...
  M = (e, t, n) => {
    ...
    let a = n.validators;
    if (a === null) return;
    let o = t === 0 ? e.join(O) : e.slice(t).join(O),
      s = a.length;
    for (let e = 0; e < s; e++) {
      let t = a[e];
  ...
  de = (e) => {
    ...
    if (t) {
      let e = t + V,
        n = r;
      r = (t) =>
        t.startsWith(e) ? n(t.slice(e.length)) : ue(le, !1, t, void 0, !0);
    }
    if (n) {
      let e = r;
  ...
  Oe = (e) => e.endsWith(`%`) && W(e.slice(0, -1)),
  K = (e) => Ce.test(e),
  ke = () => !0,
  Ae = (e) => we.test(e) && !Te.test(e),
  je = () => !1,
  Me = (e) => Ee.test(e),
  Ne = (e) => De.test(e),
  Pe = (e) => !q(e) && !X(e),
  ...
  tt = ve(() => {
    let e = H(`color`),
      ...
      j = () => [e, X, q],
      M = () => [...v(), He, ze, { position: [X, q] }],
      ae = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      oe = () => [`auto`, `cover`, `contain`, Ue, Fe, { size: [X, q] }],
      N = () => [Oe, Z, J],
      P = () => [``, `none`, `full`, l, X, q],
      F = () => [``, W, Z, J],
    ...
    return {
      ...
      classGroups: {
        ...
        "line-clamp": [{ "line-clamp": [W, `none`, X, Ie] }],
        leading: [{ leading: [a, ...S()] }],
        ...
        shadow: [{ shadow: [``, `none`, u, Ge, Y] }],
        "shadow-color": [{ shadow: j() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, Ge, Y] }],
        ...
        "text-shadow": [{ "text-shadow": [`none`, f, Ge, Y] }],
        ...
        "drop-shadow": [{ "drop-shadow": [``, `none`, ee, Ge, Y] }],
        ...
        ease: [{ ease: [`linear`, `initial`, g, X, q] }],
        delay: [{ delay: [W, X, q] }],
        animate: [{ animate: [`none`, te, X, q] }],
...
export { h as a, c, x as i, nt as n, m as o, b as r, ee as s, rt as t };
