...
import { t as n } from "./react-dom-CuViyZo3.js";
var r = e(t(), 1),
  i = e(n(), 1);
function a(e) {
  ...
  h = new (class {
    constructor() {
      ((this.subscribe = (e) => (
        ...
        (this.create = (e) => {
          let { message: t, ...n } = e,
            r = typeof e?.id == `number` || e.id?.length > 0 ? e.id : m++,
...
var O = (e) => {
  let {
    ...
    J = r.useMemo(() => u.findIndex((e) => e.toastId === n.id) || 0, [u, n.id]),
    ge = r.useMemo(() => n.closeButton ?? _, [n.closeButton, _]),
    _e = r.useMemo(() => n.duration || w || S, [n.duration, w]),
    Y = r.useRef(0),
    X = r.useRef(0),
    ve = r.useRef(0),
    Z = r.useRef(null),
    [ye, be] = O.split(`-`),
    xe = r.useMemo(
      () => u.reduce((e, t, n) => (n >= J ? e : e + t.height), 0),
      [u, J],
    ),
    Se = ee(),
    Ce = n.invert || t,
    Q = K === `loading`;
  ((X.current = r.useMemo(() => J * k + xe, [J, xe])),
    r.useEffect(() => {
      W.current = _e;
    }, [_e]),
    r.useEffect(() => {
    ...
    r.useEffect(() => {
      ...
      if (e) {
        ...
        return (
          U(t),
          s((e) => [{ toastId: n.id, height: t, position: n.position }, ...e]),
          () => s((e) => e.filter((e) => e.toastId !== n.id))
        );
      }
    }, [s, n.id]),
    r.useLayoutEffect(() => {
    ...
    }, [I, n.title, n.description, s, n.id, n.jsx, n.action, n.cancel]));
  let $ = r.useCallback(() => {
    (z(!0),
      H(X.current),
      s((e) => e.filter((e) => e.toastId !== n.id)),
  ...
  function we() {
    return M?.loading
      ? r.createElement(
          `div`,
          {
            className: D(j?.loader, n?.classNames?.loader, `sonner-loader`),
            "data-visible": K === `loading`,
          },
          M.loading,
        )
      : r.createElement(c, {
          className: D(j?.loader, n?.classNames?.loader),
          visible: K === `loading`,
        });
  }
  let Te = n.icon || M?.[K] || o(K);
  return r.createElement(
    `li`,
    {
      ...
      "data-sonner-toast": ``,
      "data-rich-colors": n.richColors ?? g,
      ...
      style: {
        ...
        "--toasts-before": d,
        "--z-index": f.length - d,
        "--offset": `${R ? le : X.current}px`,
        "--initial-height": A ? `auto` : `${ue}px`,
        ...v,
        ...n.style,
      },
      onDragEnd: () => {
        (V(!1), P(null), (Z.current = null));
      },
      onPointerDown: (e) => {
        e.button !== 2 &&
          (Q ||
            ...
            e.target.tagName !== `BUTTON` &&
              (V(!0), (Z.current = { x: e.clientX, y: e.clientY }))));
      },
      onPointerUp: () => {
        if (ae || !q) return;
        Z.current = null;
        let e = Number(
          ...
          i = N === `x` ? e : t,
          a = Math.abs(i) / r;
        if (Math.abs(i) >= T || a > 0.11) {
          (H(X.current),
            n.onDismiss == null || n.onDismiss.call(n, n),
            ie(N === `x` ? (e > 0 ? `right` : `left`) : t > 0 ? `down` : `up`),
            $(),
            oe(!0));
          return;
        } else {
      ...
      onPointerMove: (t) => {
        var n, r;
        if (!Z.current || !q || window.getSelection()?.toString().length > 0)
          return;
        let i = t.clientY - Z.current.y,
          a = t.clientX - Z.current.x,
          o = e.swipeDirections ?? ne(O);
        !N &&
          (Math.abs(a) > 1 || Math.abs(i) > 1) &&
          P(Math.abs(a) > Math.abs(i) ? `x` : `y`);
        let s = { x: 0, y: 0 },
        ...
        } else if (N === `x` && (o.includes(`left`) || o.includes(`right`)))
    ...
    ge && !n.jsx && K !== `loading`
      ? r.createElement(
          `button`,
          {
            ...
            className: D(j?.closeButton, n?.classNames?.closeButton),
          },
          M?.close ?? p,
        )
      : null,
    (K || n.icon || n.promise) && n.icon !== null && (M?.[K] !== null || n.icon)
      ? r.createElement(
          `div`,
          { "data-icon": ``, className: D(j?.icon, n?.classNames?.icon) },
    ...
    r.createElement(
      `div`,
      { "data-content": ``, className: D(j?.content, n?.classNames?.content) },
      r.createElement(
        `div`,
        { "data-title": ``, className: D(j?.title, n?.classNames?.title) },
      ...
      n.description
        ? r.createElement(
            ...
            {
              "data-description": ``,
              className: D(C, he, j?.description, n?.classNames?.description),
            },
      ...
      : n.cancel && y(n.cancel)
        ? r.createElement(
            `button`,
            {
              ...
              className: D(j?.cancelButton, n?.classNames?.cancelButton),
            },
            n.cancel.label,
          )
        : null,
    r.isValidElement(n.action)
      ? n.action
      : n.action && y(n.action)
        ? r.createElement(
            `button`,
            {
              ...
              className: D(j?.actionButton, n?.classNames?.actionButton),
            },
            n.action.label,
          )
        : null,
...
var j = r.forwardRef(function (e, t) {
  let {
    ...
    D = r.useMemo(
      () =>
        n ? T.filter((e) => e.toasterId === n) : T.filter((e) => !e.toasterId),
      [T, n],
    ),
    ne = r.useMemo(
      () =>
        Array.from(
          new Set(
            [o].concat(D.filter((e) => e.position).map((e) => e.position)),
          ),
        ),
      [D, o],
    ),
    ...
    V = r.useCallback((e) => {
      E(
        (t) => (
          t.find((t) => t.id === e.id)?.delete || h.dismiss(e.id),
        ...
        return D.length
          ? r.createElement(
              `ol`,
              {
                ...
                "data-x-position": o,
                style: {
                  "--front-toast-height": `${j[0]?.height || 0}px`,
                  "--width": `${C}px`,
                  "--gap": `${b}px`,
                  ...g,
                  ...A(d, f),
                ...
                onBlur: (e) => {
                  B.current &&
                    ...
                    ((B.current = !1),
                    (z.current &&=
                      (z.current.focus({ preventScroll: !0 }), null)));
                },
                onFocus: (e) => {
              ...
              D.filter((e) => (!e.position && n === 0) || e.position === t).map(
                (n, i) =>
                  r.createElement(O, {
                    key: n.id,
                    icons: x,
                    ...
                    removeToast: V,
                    toasts: D.filter((e) => e.position == n.position),
