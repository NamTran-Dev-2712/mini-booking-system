...
import { t as i } from "./react-dom-CuViyZo3.js";
import {
  C as a,
  E as o,
  O as s,
...
function oe(e) {
  ...
  for (let [e, r] of t)
    if (r && r.__type === `RouteErrorResponse`)
      n[e] = new b(r.status, r.statusText, r.data, r.internal === !0);
...
function se({
  ...
  let c = { ...e, loaderData: { ...e.loaderData } },
    l = o(t, r, i);
  if (l)
    for (let e of l) {
      let t = e.route.id,
        r = n(t);
      s(t, r.clientLoader, r.hasLoader, a) &&
      (r.hasHydrateFallback || !r.hasLoader)
        ? delete c.loaderData[t]
        : r.hasLoader || (c.loaderData[t] = null);
    }
  return c;
}
var ce = e(i(), 1);
function le(e) {
  return S.createElement(x, { flushSync: ce.flushSync, ...e });
}
var C = null,
  ue = null;
function de() {
...
function w({ getContext: e, instrumentations: t }) {
  ...
  if (!C.stateDecodingPromise) {
    ...
    (a(e, `No stream found for single fetch decoding`),
      ...
      (C.stateDecodingPromise = te(e, window)
        .then((e) => {
  ...
  return (
    (C.router = o),
    o.state.initialized && ((C.routerInitialized = !0), o.initialize()),
    (o.createRoutesForHMR = p),
    (window.__reactRouterDataRouter = o),
    o
  );
}
function T(e) {
