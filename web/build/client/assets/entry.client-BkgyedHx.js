...
import { t as i } from "./react-dom-dMens3Cl.js";
import {
  D as a,
  E as o,
  S as s,
...
` +
    ...
    function Ga(e) {
      ...
      function p(e, t, n, r) {
        ...
        if (typeof n == `object` && n) {
          ...
          if (de(n) || le(n)) return i === null ? d(e, t, n, r, null) : null;
    ...
    function Uo(e, t, n) {
      ...
      if (((a = e.baseState), i === null)) e.memoizedState = a;
        ...
        if (
          (l === null ? (s = a) : (l.next = c),
          !Mr(a, e.memoizedState) && ((R = !0), d && ((n = xa), n !== null)))
        )
          throw n;
        ((e.memoizedState = a),
          (e.baseState = s),
    ...
    function sc(e, t, n, r, i) {
      ...
      if (A)
        return (
          (t = fo.current),
          t === null
            ? (r !== Ki && ((t = Error(o(423), { cause: r })), $i(Oi(t, n))),
            ...
            : (!(t.flags & 65536) && (t.flags |= 256),
              (t.flags |= 65536),
              (t.lanes = i),
              r !== Ki && ((e = Error(o(422), { cause: r })), $i(Oi(e, n)))),
          !1
        );
      ...
      if (a !== null) {
        ...
        if ((ho(t), i))
          ...
          if (
            ...
            throw ((a.retryLane = s), pi(e, s), hu(r, e, s), cc);
          (Du(), (t = gc(e, t, n)));
        } else
          ((e = a.treeContext),
            (k = cf(s.nextSibling)),
...
function oe(e) {
  ...
  for (let [e, r] of t)
    if (r && r.__type === `RouteErrorResponse`)
      n[e] = new v(r.status, r.statusText, r.data, r.internal === !0);
...
function se({
  ...
  if (l)
    for (let e of l) {
      let t = e.route.id,
        r = n(t);
      o(t, r.clientLoader, r.hasLoader, a) &&
      (r.hasHydrateFallback || !r.hasLoader)
        ? delete s.loaderData[t]
        : r.hasLoader || (s.loaderData[t] = null);
    }
  return s;
}
var ce = e(i(), 1);
function le(e) {
  return S.createElement(y, { flushSync: ce.flushSync, ...e });
}
var C = null,
  ue = null;
function de() {
...
function w({ getContext: e, instrumentations: t }) {
  if ((de(), !C))
    throw Error(
  ...
  if (!C.stateDecodingPromise) {
    ...
    (s(e, `No stream found for single fetch decoding`),
      (C.context.stream = void 0),
      (C.stateDecodingPromise = b(e, window)
        .then((e) => {
  ...
  if (C.context.isSpaMode) {
    ...
    ((i = se({
      ...
      i && i.errors && (i.errors = oe(i.errors)));
  ...
  let a = l({
    ...
    getContext: e,
    hydrationData: i,
    hydrationRouteProperties: ee,
    instrumentations: t,
    mapRouteProperties: x,
    future: { v8_passThroughRequests: C.context.future.v8_passThroughRequests },
    dataStrategy: u(
      () => a,
      C.manifest,
      C.routeModules,
      C.context.ssr,
      C.context.basename,
      C.context.future.unstable_trailingSlashAwareDataRequests,
    ),
    patchRoutesOnNavigation: te(
      () => a,
      C.manifest,
      C.routeModules,
      C.context.ssr,
  ...
  return (
    (C.router = a),
    a.state.initialized && ((C.routerInitialized = !0), a.initialize()),
    (a.createRoutesForHMR = f),
    (window.__reactRouterDataRouter = a),
    a
  );
}
function T(e) {
  ue ||= w({ getContext: e.getContext, instrumentations: e.instrumentations });
  let [t, n] = S.useState(void 0);
  (S.useEffect(() => {}, []), S.useEffect(() => {}, [t]));
  let [r, i] = S.useState(ue.state.location);
  return (
    S.useLayoutEffect(() => {
      C &&
        C.router &&
    ...
    S.useLayoutEffect(() => {
      if (C && C.router)
        return C.router.subscribe((e) => {
          e.location !== r && i(e.location);
        });
    }, [r]),
    s(C, `ssrInfo unavailable for HydratedRouter`),
    a(
      ue,
      C.manifest,
      C.routeModules,
    ...
    S.createElement(
      ...
      S.createElement(
        ...
        S.createElement(
          ...
          S.createElement(le, {
            router: ue,
            useTransitions: e.useTransitions,
            onError: e.onError,
          }),
        ),
      ),
...
(0, S.startTransition)(() => {
  (0, ae.hydrateRoot)(
    document,
    (0, fe.jsx)(S.StrictMode, { children: (0, fe.jsx)(T, {}) }),
  );
});
