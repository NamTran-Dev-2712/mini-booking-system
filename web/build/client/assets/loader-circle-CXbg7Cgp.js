...
import { t as n } from "./react-dom-dMens3Cl.js";
import { t as r } from "./createLucideIcon-DIem-QJH.js";
var i = e(t(), 1),
  a = e(n(), 1);
function o(e) {
      ...
      ((this.subscribe = (e) => (
        ...
        (this.promise = (e, t) => {
          ...
          let r = Promise.resolve(e instanceof Function ? e() : e),
            ...
            s = r
              .then(async (e) => {
                if (((o = [`resolve`, e]), i.isValidElement(e)))
                  ((a = !1),
                  ...
                  let r =
                    ...
                    o =
                      typeof t.description == `function`
                        ...
                        : t.description,
                    s =
                      typeof r == `object` && !i.isValidElement(r)
                        ? r
                        : { message: r };
...
var re = (e) => {
  let {
    ...
    J = i.useMemo(() => l.findIndex((e) => e.toastId === n.id) || 0, [l, n.id]),
    ge = i.useMemo(() => n.closeButton ?? g, [n.closeButton, g]),
    _e = i.useMemo(() => n.duration || C || S, [n.duration, C]),
    Y = i.useRef(0),
    X = i.useRef(0),
    ve = i.useRef(0),
    Z = i.useRef(null),
    [ye, be] = w.split(`-`),
    xe = i.useMemo(
      () => l.reduce((e, t, n) => (n >= J ? e : e + t.height), 0),
      [l, J],
    ),
    Se = p(),
    Ce = n.invert || t,
    Q = K === `loading`;
  ((X.current = i.useMemo(() => J * re + xe, [J, xe])),
    i.useEffect(() => {
      W.current = _e;
    }, [_e]),
    i.useEffect(() => {
    ...
    i.useEffect(() => {
      ...
      if (e) {
        ...
        return (
          U(t),
          o((e) => [{ toastId: n.id, height: t, position: n.position }, ...e]),
          () => o((e) => e.filter((e) => e.toastId !== n.id))
        );
      }
    }, [o, n.id]),
    i.useLayoutEffect(() => {
    ...
    }, [I, n.title, n.description, o, n.id, n.jsx, n.action, n.cancel]));
  let $ = i.useCallback(() => {
    (z(!0),
      H(X.current),
      o((e) => e.filter((e) => e.toastId !== n.id)),
  ...
  function we() {
    return j?.loading
      ? i.createElement(
          `div`,
          {
            className: D(A?.loader, n?.classNames?.loader, `sonner-loader`),
            "data-visible": K === `loading`,
          },
          j.loading,
        )
      : i.createElement(ee, {
          className: D(A?.loader, n?.classNames?.loader),
          visible: K === `loading`,
        });
  }
  let Te = n.icon || j?.[K] || s(K);
  return i.createElement(
    ...
    ge && !n.jsx && K !== `loading`
      ? i.createElement(
          `button`,
          {
            ...
            className: D(A?.closeButton, n?.classNames?.closeButton),
          },
          j?.close ?? te,
        )
      : null,
    (K || n.icon || n.promise) && n.icon !== null && (j?.[K] !== null || n.icon)
      ? i.createElement(
          `div`,
          { "data-icon": ``, className: D(A?.icon, n?.classNames?.icon) },
    ...
    i.createElement(
      `div`,
      { "data-content": ``, className: D(A?.content, n?.classNames?.content) },
      i.createElement(
        `div`,
        { "data-title": ``, className: D(A?.title, n?.classNames?.title) },
      ...
      n.description
        ? i.createElement(
            ...
            {
              "data-description": ``,
              className: D(x, he, A?.description, n?.classNames?.description),
            },
      ...
      : n.cancel && y(n.cancel)
        ? i.createElement(
            `button`,
            {
              ...
              className: D(A?.cancelButton, n?.classNames?.cancelButton),
            },
            n.cancel.label,
          )
        : null,
    i.isValidElement(n.action)
      ? n.action
      : n.action && y(n.action)
        ? i.createElement(
            `button`,
            {
              ...
              className: D(A?.actionButton, n?.classNames?.actionButton),
            },
            n.action.label,
          )
        : null,
    ...
    let {
      ...
      D = i.useMemo(
        () =>
          Array.from(
            new Set(
              [o].concat(E.filter((e) => e.position).map((e) => e.position)),
            ),
          ),
        [E, o],
      ),
