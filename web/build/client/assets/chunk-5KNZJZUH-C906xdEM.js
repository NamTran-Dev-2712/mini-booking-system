import { a as e, n as t } from "./jsx-runtime-D0R9s8hK.js";
var n = e(t(), 1),
  r = `modulepreload`,
  i = function (e) {
    return `/` + e;
...
function Tr() {
  return { params: zn(), loaderData: rr(), actionData: ir() };
}
function Er(e) {
  return function () {
    let t = Tr();
...
function Mr(e) {
  return jr(e) && e.tagName.toLowerCase() === `button`;
}
function Nr(e) {
  return jr(e) && e.tagName.toLowerCase() === `form`;
}
function Pr(e) {
  return jr(e) && e.tagName.toLowerCase() === `input`;
}
function Fr(e) {
  return !!(e.metaKey || e.altKey || e.ctrlKey || e.shiftKey);
}
function Ir(e, t) {
  return e.button === 0 && (!t || t === `_self`) && !Fr(e);
}
var Lr = null;
function Rr() {
  if (Lr === null)
...
function Vr(e, t) {
  ...
  if (Nr(e)) {
    ...
    ((r = o ? z(o, t) : null),
      ...
      (i = Br(e.getAttribute(`enctype`)) || Ar),
      (a = new FormData(e)));
  } else if (Mr(e) || (Pr(e) && (e.type === `submit` || e.type === `image`))) {
    let o = e.form;
    if (o == null)
      throw Error(
    ...
    if (
      ((r = s ? z(s, t) : null),
      (n = e.getAttribute(`formmethod`) || o.getAttribute(`method`) || kr),
      (i =
        Br(e.getAttribute(`formenctype`)) ||
        Br(o.getAttribute(`enctype`)) ||
        Ar),
      (a = new FormData(o, e)),
      !Rr())
    ) {
...
function ui(e) {
  ...
  if (typeof e == `number`) return di.call(this, e);
  if (!Array.isArray(e) || !e.length) throw SyntaxError();
  let r = n.length;
  for (let t of e) n.push(t);
  return ((t.length = n.length), di.call(this, r));
}
function di(e) {
...
async function pi(e) {
  ...
  return { done: t.done, value: ui.call(this, n) };
}
async function mi(e) {
  let t = await e.read();
  for (; !t.done; ) {
...
var gi = {
  ...
  _i = /[&><\u2028\u2029]/g;
function vi(e) {
  return e.replace(_i, (e) => gi[e]);
}
function $(e, t) {
  if (e === !1 || e == null) throw Error(t);
}
var yi = Symbol(`SingleFetchRedirect`),
  bi = class extends Error {},
  xi = new Set([100, 101, 204, 205]);
...
function Ci(e, t, n, r, i, a, o = () => !0) {
  return async (s) => {
    let { request: c, matches: l, fetcherKey: u } = s,
      d = e();
    if (c.method !== `GET`) return wi(s, n, i, a);
    let f = l.some((e) => {
...
async function Ei(e, t, n, r, i, a, o, s = () => !0) {
  let c = new Set(),
    l = !1,
    u = e.matches.map(() => Pi()),
    d = Pi(),
      ...
      e.matches.map(async (t, i) =>
        t.resolve(async (p) => {
          ...
          try {
            f[m] = {
              type: `data`,
              result: await p(async () => Ni(await d.promise, m)),
            };
          } catch (e) {
            f[m] = { type: `error`, result: e };
          }
  ...
  return (await p, await Di(d.promise, e.matches, c, f), f);
}
  ...
  try {
    ...
    i !== void 0 &&
      Array.from(n.values()).forEach((e) => {
        r[e].result instanceof bi && (r[e].result = i);
      });
  } catch {}
}
...
async function ji(e, t, n, r) {
  let { request: i } = e,
    a = Ai(i.url, t, n, `data`);
  i.method === `GET` &&
    ((a = ki(a)), r && a.searchParams.set(`_routes`, r.join(`,`)));
  let o = await fetch(a, await hi(i));
  ...
  try {
    let e = await Mi(o.body, window),
      t;
    if (i.method === `GET`) {
      let n = e.value;
      t = yi in n ? { redirect: n[yi] } : { routes: n };
    } else {
      let n = e.value,
        i = r?.[0];
  ...
  return fi(e, {
    plugins: [
      (e, ...n) => {
        ...
        if (e === `SingleFetchRedirect`) return { value: { [yi]: n[0] } };
...
function Ni(e, t) {
  ...
  let n = e.routes[t];
  if (n == null) throw new bi(`No result found for routeId "${t}"`);
...
async function Ri(e) {
  if (!e.css) return;
  let t = Li(e);
  await Promise.all(t.map(Bi));
}
async function zi(e, t) {
  if ((!e.css && !t.links) || !Xi()) return;
  let n = [];
  if (
...
function Gi(e, t, { includeHydrateFallback: n } = {}) {
  return Ki(
    e
      .map((e) => {
        let r = t.routes[e.route.id];
...
function Ji(e, t) {
  let n = new Set(),
    r = new Set(t);
  return e.reduce((e, i) => {
    if (t && !Vi(i) && i.as === `script` && i.href && r.has(i.href)) return e;
    let a = JSON.stringify(qi(i));
...
function Xi() {
  ...
  return ((Yi = e.relList.supports(`preload`)), (e = null), Yi);
}
function Zi() {
  return n.createElement(
    Ua,
...
function ra(e, t, n, r, i, a = ``, s = Qi(e), c) {
  return (s[a] || []).map((a) => {
    let l = t[a.id];
    function u(e) {
      return (
    ...
    function f(e) {
      if (!a.hasAction) throw na(`action`, a.id);
      return u(e);
    }
    function p(e) {
      o(() => import(e), []);
    ...
    if (l) {
      Object.assign(g, {
        ...
        handle: l.handle,
        shouldRevalidate: ia(g.path, l, a, r, c),
      });
      ...
      ((g.loader = async (
        ...
        (g.loader.hydrate = ca(a.id, l.clientLoader, a.hasLoader, i)),
        (g.action = (
          ...
          h(async () => {
            if (
              ...
              if (i) throw na(`clientAction`, a.id);
              return f(s);
            }
    ...
    let _ = ra(e, t, n, r, i, a.id, s, c);
    return (_.length > 0 && (g.children = _), g);
  });
}
function ia(e, t, n, r, i) {
  if (i) return aa(n.id, t.shouldRevalidate, i);
...
function ha(e, t, r, i, a, o) {
  n.useEffect(() => {
    if (!fa(a, i) || window.navigator?.connection?.saveData === !0) return;
    function n(e) {
      let t =
        e.tagName === `FORM`
    ...
    async function s() {
      document
        ...
        .forEach(n);
      let s = Array.from(la.keys()).filter((e) =>
        da.has(e) ? (la.delete(e), !1) : !0,
      );
      if (s.length !== 0)
        try {
          await va(
...
var _a = `react-router-manifest-version`;
async function va(e, t, n, r, i, a, o, s, c, l) {
  let u = new URLSearchParams();
  (u.set(`paths`, e.sort().join(`,`)), u.set(`version`, n.version));
  let d = new URL(ga(s, o), window.location.origin);
  ...
  try {
    ...
    if (e.status === 204 && e.headers.has(`X-Remix-Reload-Document`)) {
      ...
      try {
        if (sessionStorage.getItem(_a) === n.version) {
          console.error(
            `Unable to discover routes due to manifest version mismatch.`,
          );
          return;
        }
        sessionStorage.setItem(_a, n.version);
      } catch {}
  ...
  (Object.assign(n.routes, m), e.forEach((e) => ya(e, da)));
  let h = new Set();
  (Object.values(m).forEach((e) => {
    e && (!e.parentId || !m[e.parentId]) && h.add(e.parentId);
  }),
    h.forEach((e) => c(e || null, ra(m, r, null, i, a, e))));
}
function ya(e, t) {
  if (t.size >= ua) {
...
function ka({ nonce: e, crossOrigin: t }) {
  let { isSpaMode: r, manifest: i, routeModules: a, criticalCss: o } = wa(),
    { errors: s, matches: c } = Sa(),
    l = Da(c, s, r),
    u = n.useMemo(() => Ii(l, a, i), [l, a, i]);
  return n.createElement(
    n.Fragment,
    null,
    typeof o == `string`
...
function Aa({ page: e, ...t }) {
  ...
  return a
    ? r
      ? n.createElement(Ma, { page: e, matches: a, ...t })
      : n.createElement(Na, { page: e, matches: a, ...t })
    : null;
}
function ja(e) {
  let { manifest: t, routeModules: r } = wa(),
    [i, a] = n.useState([]);
  return (
    n.useEffect(() => {
      let n = !1;
...
function Ma({ page: e, matches: t, ...r }) {
  let i = Q(),
    ...
    s = n.useMemo(() => {
      ...
      let n = Ai(e, o, a.unstable_trailingSlashAwareDataRequests, `rsc`),
        r = !1,
        s = [];
      for (let e of t)
...
function Na({ page: e, matches: t, ...r }) {
  let i = Q(),
    { future: a, manifest: o, routeModules: s } = wa(),
    { basename: c } = xa(),
    { loaderData: l, matches: u } = Sa(),
    d = n.useMemo(() => Wi(e, t, u, o, i, `data`), [e, t, u, o, i]),
    f = n.useMemo(() => Wi(e, t, u, o, i, `assets`), [e, t, u, o, i]),
    p = n.useMemo(() => {
      if (e === i.pathname + i.search + i.hash) return [];
      let n = new Set(),
        r = !1;
      if (
        ...
        return [];
      let u = Ai(e, c, a.unstable_trailingSlashAwareDataRequests, `data`);
      return (
        r &&
          n.size > 0 &&
          u.searchParams.set(
...
function Pa() {
  let { isSpaMode: e, routeModules: t } = wa(),
    { errors: r, matches: i, loaderData: a } = Sa(),
    o = Q(),
    s = Da(i, r, e),
    c = null;
      ...
      if (`script:ld+json` in e)
        try {
          ...
          return n.createElement(`script`, {
            ...
            dangerouslySetInnerHTML: { __html: vi(t) },
          });
        } catch {
          return null;
        }
...
function Ra(e) {
  let {
    ...
    { router: c, static: l, staticContext: u } = xa(),
    { matches: d } = Sa(),
    f = yn(),
    p = fa(o, s);
...
`)}
  ${p ? `window.__reactRouterManifest = ${JSON.stringify(pa(t, c), null, 2)};` : ``}
...
import(${JSON.stringify(t.entry.module)});`
    ...
    g =
      Ia || f
        ? []
        : za(t.entry.imports.concat(Gi(m, t, { includeHydrateFallback: !0 }))),
...
var Va = class extends n.Component {
  constructor(e) {
  ...
  render() {
    return this.state.error
      ? n.createElement(Ha, { error: this.state.error, isOutsideRemixApp: !0 })
      : this.props.children;
  }
};
...
function Ua({ title: e, renderScripts: t, isOutsideRemixApp: r, children: i }) {
  let { routeModules: a } = wa();
    ...
    : n.createElement(
        ...
        n.createElement(
          ...
          n.createElement(
            ...
            i,
            t ? n.createElement(Ra, null) : null,
          ),
        ),
      );
}
var Wa =
  ...
  window.document.createElement !== void 0;
try {
  Wa && (window.__reactRouterVersion = `7.15.0`);
} catch {}
function Ga({ basename: e, children: t, history: r, useTransitions: i }) {
...
Ga.displayName = `unstable_HistoryRouter`;
var Ka = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  qa = n.forwardRef(function (
    {
      onClick: e,
      discover: t = `render`,
      prefetch: r = `none`,
    ...
    return w && !y
      ? n.createElement(n.Fragment, null, k, n.createElement(Aa, { page: x }))
      : k;
  });
qa.displayName = `Link`;
var Ja = n.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: r = ``,
...
Ya.displayName = `Form`;
function Xa({ getKey: e, storageKey: t, ...r }) {
  let i = n.useContext(Ca),
    { basename: a } = n.useContext(Z),
    o = Q(),
    s = nr();
  co({ getKey: e, storageKey: t });
  let c = n.useMemo(() => {
    if (!i || !e) return null;
    let t = so(o, s, a, e);
  ...
  return n.createElement(`script`, {
    ...
    suppressHydrationWarning: !0,
    dangerouslySetInnerHTML: {
      __html: `(${l})(${vi(JSON.stringify(t || ao))}, ${vi(JSON.stringify(c))})`,
    },
  });
}
Xa.displayName = `ScrollRestoration`;
function Za(e) {
  return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`;
}
function Qa(e) {
...
function ro() {
  ...
  return n.useCallback(
    async (e, n = {}) => {
      let { action: o, method: s, encType: c, formData: l, body: u } = Vr(e, t);
      n.navigate === !1
        ? await i(n.fetcherKey || no(), r, n.action || o, {
...
var ao = `react-router-scroll-positions`,
  oo = {};
function so(e, t, n, r) {
  let i = null;
  return (
...
function co({ getKey: e, storageKey: t } = {}) {
  let { router: r } = Qa(`useScrollRestoration`),
    { restoreScrollPosition: i, preventScrollReset: a } =
      $a(`useScrollRestoration`),
  ...
  (n.useEffect(
    ...
    lo(
      n.useCallback(() => {
        ...
        try {
          sessionStorage.setItem(t || ao, JSON.stringify(oo));
        } catch (e) {
          g(
            !1,
    ...
    typeof document < `u` &&
      (n.useLayoutEffect(() => {
        try {
          let e = sessionStorage.getItem(t || ao);
          e && (oo = JSON.parse(e));
        } catch {}
      }, [t]),
      n.useLayoutEffect(() => {
...
function uo(e, { relative: t } = {}) {
  ...
  let { basename: i } = Qa(`useViewTransitionState`),
    a = Bn(e, { relative: t });
